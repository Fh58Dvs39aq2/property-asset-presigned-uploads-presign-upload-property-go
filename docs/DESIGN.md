...
> Design notes for **property-asset-presigned-uploads-presign-upload-property-go** — a runnable go example that Go service that issues policy-checked presigned browser uploads for property assets.
...
- **Feature code** — the actual task: property-asset-upload.
